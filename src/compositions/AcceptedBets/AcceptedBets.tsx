...
const BetCard: React.FC<BetCardProps> = ({ bet }) => {
  ...
  return (
    <div className="rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
      <div className="flex items-center justify-between bg-blue-200 py-2 px-3">
        <div className="text-grey-60 text-caption-12 font-medium">
          {`#${tokenId} / ${dayjs(+createdAt * 1000).format(
            "DD.MM.YYYY, HH:mm"
          )}`}
        </div>
        <BetStatus
      ...
      <div className="bg-white py-2 px-3">
        <div className="flex items-center text-caption-12 font-medium text-grey-60">
          <Icon
            ...
            name={`sport/${outcomes[0].game.sport.slug}` as IconName}
          />
          {isCombo ? (
            <>
      ...
      <div className="mt-px bg-white pt-2 px-3 pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center text-caption-12">
            {isCombo ? (
              ...
              <>
                {!isUnique && (
                  <div className="text-grey-60 mr-1">
                    {outcomes[0].marketName}:
                  </div>
                )}
          ...
          <div className="flex items-center">
            ...
            {isFreeBet && (
              <div className="flex items-center text-accent-green ml-2">
                ...
                <Message
                  className="text-caption-12 font-semibold uppercase ml-1"
    ...
    <>
      <div className="p-3">
        <Message
          ...
          value={{ ...messages.title, values: { count: bets.length } }}
        />
      </div>
